...
// --------------------------------------------------------------------------------------
BOOST_AUTO_UNIT_TEST(test_compile_time_grade_list_scalar_product)
{
    ...
    {
        VITAL_MATH_CLIFFORD_TEST_OUTER_PRODUCT(bi_vector_grades, bi_vector_grades, 2);
        BOOST_STATIC_ASSERT(result == scalar_grades);
    }
