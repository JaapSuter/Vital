...
#ifndef VITAL_MATH_CLIFFORD_SIGN_TABLE_SIGN_TABLE_3_0_HPP
#define VITAL_MATH_CLIFFORD_SIGN_TABLE_SIGN_TABLE_3_0_HPP
...
template <> struct sign_table< algebra<3, 0> >
{
