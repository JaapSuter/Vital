...
#ifndef VITAL_MATH_CLIFFORD_SIGN_TABLE_SIGN_TABLE_1_2_HPP
#define VITAL_MATH_CLIFFORD_SIGN_TABLE_SIGN_TABLE_1_2_HPP
...
template <> struct sign_table< algebra<1, 2> >
{
